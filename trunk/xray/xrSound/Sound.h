...
XRSOUND_API extern u32				psDoppler				;
...
enum {
	sdop_none		= u32(1 <<  0),
	sdop_listener	= u32(1 <<  1),
	sdop_emitter	= u32(1 <<  2),
	sdop_full		= sdop_listener | sdop_emitter,
};
...
public:
	Fvector					position;
	// Cribbledirge
	Fvector					velocity;  // Added for doppler effect.
