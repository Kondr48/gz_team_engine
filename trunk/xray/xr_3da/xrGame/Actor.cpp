...
void CActor::UpdateArtefactsOnBelt()
{
...
#endif
	{
		...
		if (artefact)
		{
			conditions().ChangeBleeding         (artefact->GetBleedingRestoreSpeed()  *  f_update_time);
			conditions().ChangeHealth           (artefact->GetHealthRestoreSpeed()    *  f_update_time);
...
#endif
		    artefact->ChangeCondition           (artefact->m_fConditionLoss           *  f_update_time);
		}
