	...
	case GE_OWNERSHIP_TAKE:
		{
            ...
            if( m_in_use )
			{
				...
				Actor()->callback(GameObject::eDropItemOutBox)( this->lua_game_object(), GO->lua_game_object() );
			}
		}break;
	case GE_OWNERSHIP_REJECT:
		{
			...
			{
				CGameObject* GO		= smart_cast<CGameObject*>(itm);
				Actor()->callback(GameObject::eTakeItemFromBox)( this->lua_game_object(), GO->lua_game_object() );
			}
		}break;
	};
}
