...
#ifdef NEW_BAL
		cartridge.m_flags.set				(CCartridge::cfTracer,TRUE); 	//NewBal Включить трассеры у осколков
		cartridge.m_flags.set				(CCartridge::cfRicochet,TRUE); 	//NewBal Включить рикошет у осколков
#else
