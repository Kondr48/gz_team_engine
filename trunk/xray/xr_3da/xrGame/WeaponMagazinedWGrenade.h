...
public:
	...
	MotionSVec          mhud_idle_sprint_g; //Kondr48: анимации спринта для подствольного гранатомёта
	MotionSVec          mhud_idle_moving_g; //Kondr48: анимации ходьбы для подствольного гранатомёта
	...
	MotionSVec			mhud_idle_sprint_gl; //Kondr48: анимации спринта для подствольного гранатомёта
    MotionSVec			mhud_idle_moving_gl; //Kondr48: анимации ходьбы для подствольного гранатомёта
