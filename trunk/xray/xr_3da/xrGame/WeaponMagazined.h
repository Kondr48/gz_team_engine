...
protected:
	...
	HUD_SOUND		sndReloadMisfire;   //anim_rouge, Kondr48: расклин.	
	...
	ESoundTypes		m_eSoundReloadMisfire;    //anim_rouge, Kondr48: расклин.	
...
protected:
	...
	virtual void	switch2_ReloadMisfire	(); //anim_rouge, Kondr48: расклин.	
...
protected:
	...
	virtual void	ReloadMisfire	();   //anim_rouge, Kondr48: расклин.	
...
protected:
    ...
    bool			m_bChamberStatus; //Kondt48: патрон в патроннике.
	bool			m_chamber; 
...
protected:
	...
	virtual void	PlayAnimReloadMisfire(); //anim_rouge, Kondr48: расклин.	
