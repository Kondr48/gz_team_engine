...
CWound* CEntityCondition::ConditionHit(SHit* pHDS)
{
	...
	case ALife::eHitTypeChemicalBurn:
		...
		if(hit_power < 0.f)
			hit_power = 0.f;
		hit_power *= m_HitTypeK[pHDS->hit_type]-m_fBoostChemicalBurnImmunity;
		break;
	...
	case ALife::eHitTypeRadiation:
		...
		if(hit_power < 0.f)
			hit_power = 0.f;
		hit_power			*= m_HitTypeK[pHDS->hit_type]-m_fBoostRadiationImmunity;
	...
	case ALife::eHitTypeWound:
		hit_power *= m_HitTypeK[pHDS->hit_type]-m_fBoostWoundImmunity;
		m_fHealthLost = hit_power*m_fHealthHitPart*m_fHitBoneScale;
		m_fDeltaHealth -= CanBeHarmed() ? m_fHealthLost : 0;
		m_fDeltaPower -= hit_power*m_fPowerHitPart;
		break;
