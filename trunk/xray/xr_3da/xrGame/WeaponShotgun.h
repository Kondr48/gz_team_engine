...
protected:
	...
	bool			m_bDupletStatus; //Kondr48: для выстрела дуплетом на кнопку ПГ

	bool			m_bBoltAction;	//anim_rouge: для корректного учета патронов оружия с зарядкой через гильзосброс
	...
	HUD_SOUND		m_sndOpenEmpty; //anim_rouge: пустая зарядка дробовика, звук
	HUD_SOUND		m_sndOpen;
	HUD_SOUND		m_sndAddCartridge;
	HUD_SOUND		m_sndClose;
	MotionSVec		mhud_open_empty; //anim_rouge: пустая зарядка дробовика, анимация
