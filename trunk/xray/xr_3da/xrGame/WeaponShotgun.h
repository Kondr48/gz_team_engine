...
public:
	...
	virtual void	PlayAnimOpenWeaponEmpty	();	//anim_rouge: пуста€ зар€дка дробовика
...
protected:
	...
	bool			m_bDupletStatus; //Kondr48: дл€ выстрела дуплетом на кнопку ѕ√

	bool			m_bBoltAction;	//anim_rouge: дл€ корректного учета патронов оружи€ с зар€дкой через гильзосброс
	...
	HUD_SOUND		m_sndOpenEmpty; //anim_rouge: пуста€ зар€дка дробовика, звук
	HUD_SOUND		m_sndOpen;
	HUD_SOUND		m_sndAddCartridge;
	HUD_SOUND		m_sndClose;
	MotionSVec		mhud_open_empty; //anim_rouge: пуста€ зар€дка дробовика, анимаци€
