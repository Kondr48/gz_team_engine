...
void CArtefact::Load(LPCSTR section) 
{
	...
	if(m_bLightsEnabled){
		...
		m_fPowerLifeRestoreSpeed     = pSettings->r_float(section,"power_life_restore_speed");
		m_additional_weight		     = pSettings->r_float(section,"additional_inventory_weight");

		m_fConditionLoss             = pSettings->r_float	        (section,"condition_loss_speed"     );
...
void CArtefact::ChangeCondition (float fDeltaCondition)
{
