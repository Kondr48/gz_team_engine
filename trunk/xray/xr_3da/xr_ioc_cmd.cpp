...
xr_token							snd_doppler_token						[ ]={
	{ "sdop_none",					sdop_none									},
	{ "sdop_listener",				sdop_listener								},
	{ "sdop_emitter",				sdop_emitter								},
	{ "sdop_full",					sdop_full									},
	{ 0,							0											}
};
...
public:
	...
	virtual void	Execute	(LPCSTR args)
	{
		...
		inherited::Execute	("renderer_r2_5");
#else
...
//	CMD4(CCC_Integer,	"rs_ib_size",			&rsDIB_Size,		32,		4096);
	...
	CMD3(CCC_Token,		"snd_doppler_effect",	&psDoppler,			snd_doppler_token	);
